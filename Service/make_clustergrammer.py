...
class LoadFile:
    def __init__(self):
        pass
    def make_json_from_txt(self, input, link):
        #net.load_file('main/Service/rc_two_cats.txt')

        net.load_df(input)

        print link

        # net.add_cats(axis='column', cat_data=cat_data)
        ...
        # net.cluster(dist_type='jaccard', views=['N_row_sum', 'N_row_var'], dendro=True, linkage_type=link,
        ...
        return net.export_net_json('viz')
        
        #net.write_json_to_file('viz', '../static/clustergrammer/demo.json', 'indent')

    #net.load_file('../static/clustergrammer/example_tsv_network.txt')
